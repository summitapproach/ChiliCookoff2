...
namespace ChiliCookoff2.Providers
{
    public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override Task GrantRefreshToken(OAuthGrantRefreshTokenContext context)
        {
            ...
            else
            {
                ...
                AuthenticationProperties properties = CreateProperties(userIdentity.GetUserName());

                var authenticationTicket = new AuthenticationTicket(userIdentity, properties);
